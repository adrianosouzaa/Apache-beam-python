...
pipeline_options = {
    ...
    'staging_location': 'gs://curso-apache-beam12/temp',
    'temp_location': 'gs://curso-apache-beam12/temp',
    'template_location': 'gs://curso-apache-beam12/template/job_bath_GCS_BQ_voos',
...
tabela = 'curso-dataflow-beam-323618:curso_dataflow_voos.curso_dataflow_voos_atraso'

Tempo_Atrasos = (
  p1
  | "Importar Dados Atraso" >> beam.io.ReadFromText(r"gs://curso-apache-beam12/entrada/voos_sample.csv", skip_header_lines = 1)
...
Qtd_Atrasos = (
  p1
  | "Importar Dados" >> beam.io.ReadFromText(r"gs://curso-apache-beam12/entrada/voos_sample.csv", skip_header_lines = 1)
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location = 'gs://curso-apache-beam12/temp' )
